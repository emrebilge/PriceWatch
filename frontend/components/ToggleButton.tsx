...
/*     useEffect(() => {
    ...
    return (
        <div onClick={iconToggle}>
            {isDark ? (
                <img 
  className="h-8 w-auto moon rounded-full duration-300 hover:cursor-pointer hover:bg-current hover:opacity-25 hover:scale-125 transform transition-transform"
  src='/moon_icon.svg' 
  alt="Moon Icon" 
/>
